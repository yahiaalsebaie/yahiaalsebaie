...
- :desktop_computer: &nbsp;Developing desktop and backend applications using **C++** and **C# / .NET**.
- :floppy_disk: &nbsp;Designing relational databases and managing data architecture with **SQL Server** and **ADO.NET**.
- :brain: &nbsp;Applying advanced **Object-Oriented Programming (OOP)** principles to build clean, maintainable software.
- :computer: &nbsp;Connect with me on **[LinkedIn](https://www.linkedin.com/in/yahia-al-sebaie)**

<br>

<h2 align="left" id="yahia-tech">Skills & Tech Stack</h2>

> Core languages, frameworks, databases, and tools I work with.
